...
<link rel="stylesheet" href="/res/css/body.css" type="text/css" />
	...
	<table class="submit_hint">
		...
		<tr>
			<td style="font-size: 14px; color: #ff0000; padding-top: 2px;" align='center' valign="middle">
				<img alt="错误" src="/res/images/info.png" align="middle" height="30" width="30" /> 
				<span style="vertical-align: middle">${exceptionResultInfo.message}</span>
				<span style="vertical-align: middle">${exceptionResultInfo.type }</span>
			</td>
		</tr>
	</table>
	<table width='100%'>
