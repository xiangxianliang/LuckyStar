			...
			<tbody>
				<tr>
					...
					<td width="80%" class="pn-fcontent">
						<input type="text" class="text statelong" name="ebBrandCustom.brandName" maxlength="100" 
				...
				<tr>
					<td width="20%" class="pn-flabel pn-flabel-h"></td>
						...
						<input type="hidden" name="ebBrandCustom.imgUrl" id="path"/>
				...
				<tr>
					...
					<td width="80%" class="pn-fcontent">
						<input type="text" name="ebBrandCustom.brandDescription" class="text statelong" maxlength="80"  size="60" 
				...
				<tr>
					...
					<td width="80%" class="pn-fcontent">
						<input type="text" name="ebBrandCustom.brandRemark" class="text statelong"  maxlength="80" size="60" 
							reg="^[\S]{0,200}$" tip="可选值不能为空，单个选项长度1-200" />
						<br/>
						<span></span>
					</td>
				...
				<tr>
					...
					<td width="80%" class="pn-fcontent">
						<input type="text" name="ebBrandCustom.pinyinCode" class="text statelong"  maxlength="80" size="60" 
							reg="^[\S]{0,200}$" tip="可选值不能为空，单个选项长度1-200" />
						<br/>
						<span></span>
					</td>
				...
				<tr>
					<td width="20%" class="pn-flabel pn-flabel-h">品牌网址:</td>
					<td width="80%" class="pn-fcontent">
						<input type="text" name="ebBrandCustom.webSite" 
				...
				<tr>
					<td width="20%" class="pn-flabel pn-flabel-h">
						...
						<input type="text" id="showorder" name="ebBrandCustom.showorder" class="text statelong" maxlength="80" 
				...
				<tr>
					...
					<td width="80%" class="pn-fcontent">
						<input type="radio" name="ebBrandCustom.isDisplay" value="1" checked="checked" reset="false" />可用
						<input type="radio" name="ebBrandCustom.isDisplay" value="0"/>不可用
					</td>
				</tr>
				<tr>
					<td width="20%" class="pn-flabel pn-flabel-h">父节点:</td>
					<td width="80%" class="pn-fcontent">
						<input type="text" id="typeName" name="ebBrandCustom.typeName" value="${p_tc.typeName }"
							disabled="disabled" class="text state" maxlength="25"  />
						<input id="typeId" type="hidden" name="ebBrandCustom.typeId" value="${p_tc.typeId }" />
					</td>
				</tr>
			</tbody>
			<tbody>
