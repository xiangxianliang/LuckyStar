		...
		<table width="100%" border="0" cellspacing="0"cellpadding="0">
			<tr>
				...
				<td width="40" align="center" valign="bottom">
					<img src="/res/jeecms/img/login/line.jpg" width="23" height="232" />
				</td>
				<td valign="top">
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						<tr>
							...
							<td>
								...
								<table width="100%" border="0" align="center" cellpadding="0"cellspacing="5">											
									<tr>
										...
										<td width="211">
											<input type="input" id="username" name="username" vld="{required:true}" maxlength="100"	class="input" />
										</td>
									</tr>
									<tr>
									...
									<tr>
										<td colspan="2" align="center">
											<imgsrc="${base}/captcha.svl" onclick="this.src='/captcha.svl?d='+new Date()*1" />
										</td>
									</tr>
									<tr>
										<td height="40" align="right">
									...
									<tr>
										...
										<input type="image" src="/res/jeecms/img/login/login.jpg" name="submit" /> &nbsp; &nbsp; 
											<img name="reg" style="cursor: pointer"	src="/res/jeecms/img/login/reset.jpg" onclick="document.forms[0].reset()" />
										</td>
									</tr>
								</table>
							</td>
