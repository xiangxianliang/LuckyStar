...
<div class="box-positon">
	<div class="rpos">当前位置: 前台用户管理 - 编辑</div>
	<form class="ropt">
...
<tbody>
	<tr>
		...
		<td width="80%" class="pn-fcontent">
			<input type="text" id="username" name="ebFrontUserCustom.username" class="text state" maxlength="100"
				reg="^[a-zA-Z0-9\u4e00-\u9fa5]{1,25}$" tip="必须是中英文或数字字符，长度1-25" value="${ebFrontUserCustom.username }" />
			<span></span>
		</td>
	</tr>
	...
	<tr>
		...
		<td width="80%" class="pn-fcontent">
			<input type="text" id="password" name="ebFrontUserCustom.password" class="text state" maxlength="100"
				reg="^[a-zA-Z0-9\u4e00-\u9fa5]{1,25}$" tip="必须是中英文或数字字符，长度1-25" value="" />
			<span></span>
		</td>
	</tr>
	...
	<tr>
		...
		<td width="80%" class="pn-fcontent">
			<input type="text" id="nickname" name="ebFrontUserCustom.nickname" class="text state" maxlength="100"
				reg="^[a-zA-Z0-9\u4e00-\u9fa5]{1,25}$" tip="必须是中英文或数字字符，长度1-25" value="${ebFrontUserCustom.nickname }" />
			<span></span>
		</td>
	</tr>
	<tr>
		...
		<td width="80%" class="pn-fcontent">
			<input name="ebFrontUserCustom.gender" type="radio" value="MAN" checked="checked" 
				<c:if test="${ebFrontUserCustom.gender == 'MAN' }">checked="checked"</c:if> />是&nbsp;&nbsp; 
			<input name="ebFrontUserCustom.gender" type="radio" value="WOMAN"
				<c:if test="${ebFrontUserCustom.gender == 'WOMAN' }">checked="checked"</c:if> />否&nbsp;&nbsp; 
			<span></span>
		</td>
	</tr>
	<tr>
		...
		<td width="80%" class="pn-fcontent">
			<input type="text" id="realName" name="ebFrontUserCustom.realName" class="text state" maxlength="100"
				reg="^[a-zA-Z0-9\u4e00-\u9fa5]{1,25}$" tip="必须是中英文或数字字符，长度1-25" value="${ebFrontUserCustom.realName }" />
			<span></span>
		</td>
	</tr>
	<tr>
		...
		<td width="80%" class="pn-fcontent">
			<input type="text" id="idCard" name="ebFrontUserCustom.idCard" class="text state" maxlength="100"
				reg="^[a-zA-Z0-9\u4e00-\u9fa5]{1,25}$" tip="必须是中英文或数字字符，长度1-25" value="${ebFrontUserCustom.idCard }" />
			<span></span>
		</td>
	</tr>
		<tr>
		...
		<td width="80%" class="pn-fcontent">
			<input type="text" id="birthday" name="ebFrontUserCustom.birthday" class="text state" maxlength="100"
				reg="^[a-zA-Z0-9\u4e00-\u9fa5]{1,25}$" tip="必须是中英文或数字字符，长度1-25" value="${ebFrontUserCustom.birthdayStr }" />
			<span></span>
		</td>
	</tr>
	<tr>
		...
		<td width="80%" class="pn-fcontent">
			<input type="text" id="email" name="ebFrontUserCustom.email" class="text state" maxlength="100"
				reg="^[a-zA-Z0-9\u4e00-\u9fa5]{1,25}$" tip="必须是中英文或数字字符，长度1-25" value="${ebFrontUserCustom.email }" />
			<span></span>
		</td>
	</tr>
	<tr>
		...
		<td width="80%" class="pn-fcontent">
			<span class="word">
				<select name="ebFrontUserCustom.provinceId" id="province" onchange="changeProvince()">
					...
					<c:forEach items="${ebProvinceList }" var="province">
						<option id="p${province.code }" value="${province.provinceId }" code="${province.code }"
							<c:if test="${ebFrontUserCustom.provinceId == province.provinceId }">selected="selected"</c:if> >${province.name }</option>
					</c:forEach>
				...
				<select name="ebFrontUserCustom.cityId" id="city" onchange="changeCity()" >
					...
					<c:forEach items="${ebCityList }" var="city">
						<option id="c${city.code }" value="${city.cityId }" code="${city.code }"
							<c:if test="${ebFrontUserCustom.cityId == city.cityId }">selected="selected"</c:if> >${city.name }</option>
					</c:forEach>
				</select>
				
				<select name="ebFrontUserCustom.townId" id="town" onchange="changeTown()" >
					<option value="">县/区</option>
					<c:forEach items="${ebTownList }" var="town">
						<option id="t${town.code }" value="${town.townId }" code="${town.code }"
							<c:if test="${ebFrontUserCustom.townId == town.townId }">selected="selected"</c:if> >${town.name }</option>
					</c:forEach>
				</select>
			</span>
			<span></span>
	...
	<tr>
		...
		<td width="80%" class="pn-fcontent">
			<input type="text" id="addr" name="ebFrontUserCustom.addr" class="text state" maxlength="100"
				reg="^[a-zA-Z0-9\u4e00-\u9fa5]{1,25}$" tip="必须是中英文或数字字符，长度1-25" value="${ebFrontUserCustom.addr }" />
			<span></span>
		</td>
	</tr>
	<tr>
		...
		<td width="80%" class="pn-fcontent">
			<input type="text" id="zipCode" name="ebFrontUserCustom.zipCode" class="text state" maxlength="100"
				reg="^[a-zA-Z0-9\u4e00-\u9fa5]{1,25}$" tip="必须是中英文或数字字符，长度1-25" value="${ebFrontUserCustom.zipCode }" />
			<span></span>
		</td>
	</tr>
	<tr>
		...
		<td width="80%" class="pn-fcontent">
			<input type="text" id="phone" name="ebFrontUserCustom.phone" class="text state" maxlength="100"
				reg="^[a-zA-Z0-9\u4e00-\u9fa5]{1,25}$" tip="必须是中英文或数字字符，长度1-25" value="${ebFrontUserCustom.phone }" />
			<span></span>
		</td>
	</tr>
	<tr>
		...
		<td width="80%" class="pn-fcontent">
			<input type="text" id="cellphone" name="ebFrontUserCustom.cellphone" class="text state" maxlength="100"
				reg="^[a-zA-Z0-9\u4e00-\u9fa5]{1,25}$" tip="必须是中英文或数字字符，长度1-25" value="${ebFrontUserCustom.cellphone }" />
			<span></span>
		</td>
	</tr>
	<tr>
		...
		<td width="80%" class="pn-fcontent">
			<input type="text" id="qqNum" name="ebFrontUserCustom.qqNum" class="text state" maxlength="100"
				reg="^[a-zA-Z0-9\u4e00-\u9fa5]{1,25}$" tip="必须是中英文或数字字符，长度1-25" value="${ebFrontUserCustom.qqNum }" />
			<span></span>
		</td>
	</tr>
	<tr>
		...
		<td width="80%" class="pn-fcontent">
			<input type="text" id="wxNum" name="ebFrontUserCustom.wxNum" class="text state" maxlength="100"
				reg="^[a-zA-Z0-9\u4e00-\u9fa5]{1,25}$" tip="必须是中英文或数字字符，长度1-25" value="${ebFrontUserCustom.wxNum }" />
			<span></span>
		</td>
	</tr>
	<tr>
		...
		<td width="80%" class="pn-fcontent">
			<input type="text" id="introInfo" name="ebFrontUserCustom.introInfo" class="text state" maxlength="100"
				reg="^[a-zA-Z0-9\u4e00-\u9fa5]{1,25}$" tip="必须是中英文或数字字符，长度1-25" value="${ebFrontUserCustom.introInfo }" />
			<span></span>
		</td>
	</tr>
	<tr>
		...
		<td width="80%" class="pn-fcontent">
			<input name="ebFrontUserCustom.status" type="radio" value="1" checked="checked" 
				<c:if test="${ebFrontUserCustom.status == 1 }">checked="checked"</c:if> />是&nbsp;&nbsp; 
			<input name="ebFrontUserCustom.status" type="radio" value="0"
				<c:if test="${ebFrontUserCustom.status == 0 }">checked="checked"</c:if> />否&nbsp;&nbsp; 
			<span></span>
		</td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td width="80%" class="pn-fcontent">
			...
			<input type="hidden" id="path" name="ebFrontUserCustom.userImg" value="${ebFrontUserCustom.userImg }" />
