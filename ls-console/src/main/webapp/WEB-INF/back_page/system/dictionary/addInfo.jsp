...
<div class="box-positon">
	<div class="rpos">当前位置: 模块 - 添加</div>
	<div class="clear"></div>
</div>
<div class="body-box" style="float:left">
	<form id="form111" name="form111" action="/system/dictionary/addInfo.do" method="post">
		<input type="hidden" id="typeId" name="sysDictInfoCustom.typeId" value="${typeCustom.typeId }" />
			...
			<tbody>
				<tr>
					...
					<td width="80%" class="pn-fcontent">
						<input type="text" id="infoDescription" name="sysDictInfoCustom.infoDescription" class="text statelong" maxlength="200"/>
						<br/>
				...
				<tr>
					...
					<td width="80%" class="pn-fcontent">
						<input type="text" id="infoRemark" name="sysDictInfoCustom.infoRemark" class="text statelong" maxlength="200"/>
						<br/>
				...
				<tr>
					...
					<td width="80%" class="pn-fcontent">
						<input type="text" id="infoValue" name="sysDictInfoCustom.infoValue" class="text state" maxlength="200"/>
						<br/>
				...
				<tr>
					...
					<td width="80%" class="pn-fcontent">
						<input id="g3" type="radio" name="sysDictInfoCustom.valueType" value="1" checked="checked" />业务字段
						&nbsp;&nbsp;&nbsp;&nbsp;
						<input id="g4" type="radio" name="sysDictInfoCustom.valueType" value="0" />字典字段
						<br/>
						<label for="sysDictInfoCustom.valueType" class="error" style="display: none;"></label>
					</td>
				</tr>
				<tr>
					<td width="20%" class="pn-flabel pn-flabel-h">
					...
					<td width="80%" class="pn-fcontent">
						<input type="text" id="showorder" name="sysDictInfoCustom.showorder" class="text state" maxlength="25"/>
						<br/>
				...
				<tr>
					...
					<td width="80%" class="pn-fcontent">
						<input id="g1" type="radio" name="sysDictInfoCustom.isEnable" value="1" checked="checked" />是
						&nbsp;&nbsp;&nbsp;&nbsp;
						<input id="g2" type="radio" name="sysDictInfoCustom.isEnable" value="0" />否
						<br/>
				...
				<tr>
					...
					<td width="80%" class="pn-fcontent">
						<input type="text" id="typeName" disabled="disabled" class="text state" maxlength="25" value="${typeCustom.typeName }" />
						<span></span>
					</td>
				</tr>
			</tbody>
